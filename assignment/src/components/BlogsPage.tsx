                ...
                >
                  ...
                  <div className="relative h-56 overflow-hidden">
                    ...
                    <div className={`absolute bottom-4 left-4 right-4 text-white transition-all duration-300 transform ${
                      ...
                      <Link
                        to={`/blog/${blog.id}`}
                        className="bg-yellow-400 text-gray-800 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-yellow-300 transition-colors inline-block"
                      >
                        Read More
                      </Link>
                    </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white shadow-lg rounded-2xl p-6">
              ...
              <div className="space-y-4">
                ...
                {sidebarTab === "recent" &&
                  recentBlogs.map((b) => (
                    <Link key={b.id} to={`/blog/${b.id}`} className="group block cursor-pointer">
                      <div className="flex gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                        <img src={b.image} alt={b.title} className="w-12 h-12 rounded-lg object-cover" />
                        <div className="flex-1">
                          <p className="text-sm font-medium text-gray-800 group-hover:text-yellow-600 transition-colors line-clamp-2">{b.title}</p>
                ...
                {sidebarTab === "comments" &&
                  commentsData.map((c, i) => {
                    ...
                    if (!blog) return null;
                    return (
                      <Link key={i} to={`/blog/${blog.id}`} className="block cursor-pointer">
            ...
            <div className="bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-2xl p-6 text-gray-800">
              ...
              <div className="space-y-2">
                <input type="email" placeholder="Your email address" className="w-full px-3 py-2 rounded-lg border-0 focus:ring-2 focus:ring-white text-sm" />
